...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-color: white">
        @foreach ($leaveSummary as $summary)
            <div class="container-fluid page_break" style="display: flex;" >
                <div class="row">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        Birth Date: {{ $summary['birthdate'] }} <br>
                                        Civil Status: {{ $summary['civilstatus'] }} <br>
                                    </td>
                                    <td>
                                        Position: {{ @$summary['position_title'] }}<br>
                                        Office: {{ @$summary['department_title'] }}<br>
                                        Salary Grade: {{ @$summary['salary_grade'] }}<br>
                                    </td>
                                    <td>
                                        Date Hired: <br>
                                        Retirement Date: {{ Carbon\Carbon::parse($summary['birthdate'] )->addYears(60)->format('Y-m-d') }} <br>
                                        Status:
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="col-md-12 p-0">
                        <table class="table table-striped table-bordered text-center p-0">
                            ...
                            <tbody>
                                @foreach ($summary['data'] as $leave_card)
                                    <tr>
