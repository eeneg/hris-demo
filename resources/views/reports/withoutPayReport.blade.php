                    ...
                    <table class="tablemain" style="margin-bottom: 200px;">
                        <thead class="theadTitle">
                            <th colspan="4">
                                <div class="header" style="text-align: center">
                                    <h1 style="font-weight: bold;margin:0">{{$d['type'] == "SLWOP" ? "Sick Leave Without Pay" : "Vacation Leave Without Pay"}}</h1>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="tdata2" style="border-right: none; border-top: none;">{{ $values['type'] }}</td>
                                <td class="tdata2" style="border-right: none; border-top: none;">{{ $values['count'] }}</td>
                                <td class="tdata2" style="border-top: none;">{{ $values['month'] }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
