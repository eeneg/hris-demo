        ...
        <div class="page-break" style="position: relative; margin-left: 90px !important; padding: 0;">
            <div style="margin-bottom: 20px;">
                <table align="left" cellspacing="0" border="0">
                    ...
                    @endforeach
                        <tr>
                            <td style="text-align: center;" height="20" align="left" valign=middle>
                            ...
                            <td style="" colspan=3 align="center" valign=middle>
                            ...
                            <td style="" colspan=5 align="center" valign=middle>

                            </td>
                        </tr>
                </table>
                <div style="width: 1315px; margin-top: 10px;">
                    <table style="display:inline-table; width: 1300px; margin-left: 50px;" valign=top>
                        ...
                        <tbody>
                             ...
                             @foreach ($d['prep'] as $key => $prep)
                                 <tr>
                                    <td></td>
                                    <td style="padding: 0%; text-align: center; height: 50px;">
                                        <h2 style="margin: 0px; padding: 0%;">{{$prep['name']}}</h2>
                                        <h3 style="margin: 0%; padding: 0%;"> {{$prep['position']}}</h3>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td style="padding: 0%; text-align: center; height: 50px;">
                                        @if ($key == 0)
                                            <h2 style="margin: 0px; padding: 0%;">{{$d['noted']['name']}}</h2>
                                            <h3 style="margin: 0px; padding: 0%;">{{$d['noted']['position']}}</h3>
                                        @endif
                                    </td>
                                 </tr>
                                 <tr>
