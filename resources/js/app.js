...
const routes = [
    ...
    { path: '/employee-view-leave-card', component: require('./components/employees/EmployeeLeaveCard.vue').default },
    ...
    { path: '/loyalty', component: require('./components/reports/LoyaltySchedule.vue').default },
