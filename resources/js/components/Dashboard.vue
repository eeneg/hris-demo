      ...
      <div class="container-fluid">
        ...
        <div class="row">
              ...
              <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <table class="table m-0">
                        ...
                        <tr>
                        <td><a href="pages/examples/invoice.html">John Doe</a></td>
                        <td>Applied for leave</td>
                        <td style="text-align: right;"><span class="badge badge-warning">Pending</span></td>
                        
                        </tr>
                        <tr>
                        <td><a href="pages/examples/invoice.html">Jane Doe</a></td>
                        <td>Updated his profile</td>
                        <td style="text-align: right;"><span class="badge badge-danger">Delivered</span></td>
                        ...
                        <tr>
                        <td><a href="pages/examples/invoice.html">Mark Hernan</a></td>
                        <td>Appointed as Vice Governor</td>
                        <td style="text-align: right;"><span class="badge badge-success">06/15/21</span></td>
          ...
          <section class="col-lg-4 connectedSortable ui-sortable">
            ...
            <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Birthday(s) Today</h3>
            ...
            <!-- <div class="card">
                    ...
                    <div class="card-body p-0">
                        ...
                        <li class="item">
                            ...
                            <a href="javascript:void(0)" class="product-title">
                                Gene Gwapo
                                <span class="float-right users-list-date">35 mins</span>
                            </a>
                            <span class="product-description">
