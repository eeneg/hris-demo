...
class LeaveApprovedListener
{
    ...
    public function handle(LeaveProcessed $event)
    {
        ...
        $leave = [
            ...
            'vl_earned' => 0,
            'vl_withpay' => $data->vacation_less != null && $data->days_with_pay != null ? $data->days_with_pay : '',
            'vl_balance' => $vl_credits->balance - $data->vacation_less,
            'vl_withoutpay' => $data->vacation_less != null && $data->days_with_pay != null ? $data->days_without_pay : '',
            'sl_earned' => 0,
            'sl_withpay' => $data->sick_less != null && $data->days_with_pay != null ? $data->days_with_pay : '',
            'sl_balance' => $sl_credits->balance - $data->sick_less,
            'sl_withoutpay' => $data->sick_less != null && $data->days_with_pay != null ? $data->days_without_pay : '',
